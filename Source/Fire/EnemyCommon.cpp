...
void AEnemyCommon::Trace(FName StartSocket, FName EndSocket)
{
}


void AEnemyCommon::Trace(FName StartSocket, float RangeTrace)
{

}

void AEnemyCommon::TraceClear()
{
}

void AEnemyCommon::SetParametsForElite()
{
	Cast<AAIController_Base>(GetController())->SetIsEliteKey();
	IsElite = true;
	SetEliteParamets();
